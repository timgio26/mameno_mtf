...
class TblMemo(db.Model):
    ...
    linkmemo: Mapped[str] = mapped_column(Text)

    def to_dict(self):
        return {
            "id": self.id,
            "penulis_memo": self.penulis_memo,
            "judul_memo": self.judul_memo,
            "tanggal_buat": self.tanggal_buat,
            "tahun_memo": self.tahun_memo,
            "no": self.no,
            "no_memo": self.no_memo,
            "linkmemo": self.linkmemo
        }
...
class TblBeli(db.Model):
    ...
    linkbeli: Mapped[str] = mapped_column(Text)
